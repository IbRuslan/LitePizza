...
import {removeProducts} from "../store/cart-reducer";
        ...
        <div className='container container--cart'>
            <div className="cart">
                ...
                <div className="cart__top">
                    ...
                    <div className="cart__clear" onClick={() => dispatch(removeProducts())}>
                ...
                {
                    cart.items.map(p => <CartItem key={p.id} pizza={p}/>)
                }
                <div className="cart__bottom">
                    ...
                    <div className="cart__bottom-buttons">
                        <Link to="/LitePizza" className="button button--outline button--add go-back-btn">
